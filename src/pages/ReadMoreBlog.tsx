  ...
  return (
    <div className="py-16 mt-10 w-[91%] mx-auto">
      ...
      <div className="flex justify-between items-center">
        <span className="text-[1rem] text-main-light_white font-miligramTextMedium">SEP 22, 2022</span>
      </div>
      ...
      >
        <span className="text-[1.6rem]">Lorem</span> ipsum dolor sit amet, consectetur adipiscing elit. Pellentesque a
      ...
      <div className={`text-main-light_white font-miligramTextBook overflow-hidden mt-3 max-h-0 transition-all duration-500 ${showMore ? "max-h-[230px]" : ""}`}>
        Vel cras ipsum commodo, nunc sed posuere mattis tristique massa. Ut
        neque, nascetur ipsum sed nisl. Tincidunt in penatibus mauris enim
        lacus, viverra senectus arcu bibendum. Posuere neque in id tellus
        elementum. Rutrum posuere amet ut orci. Bibendum tellus, enim ̰
