    ...
    <>
      <div className="sm:flex justify-center pl-4 xsm:px-6 sm:pl-20 py-10 bg-main-secondary">
        <div className="w-full sm:w-1/4  font-miligramText400">
          ...
          <div className="flex justify-start items-start  mt-4 text-[0.9rem] sm:text-[1rem]">
            <img
              src={location}
              alt="location"
              className={
          ...
          <div className="flex justify-start  mt-3">
            ...
            <a
              ...
              className={`group relative text-main-light_white m-0 text-[0.9rem] sm:text-[1rem] mt-[4px] hover:text-white`}
            >
              0135-3504103
              <AnimatedBorder />
            </a>
            ...
            return (
              <div className="w-1/2 sm:w-1/4 mt-6 sm:mt-0" key={i}>
                ...
                {item.buttons.map((item, i) => (
                  ...
                  >
                    {item.title === "Pricing" ? (
                      <HashLink to="/#pricingSec">{item.title}</HashLink>
                    ) : (
                      item.title
                    )}
                    <AnimatedBorder />
