  ...
  return (
    ...
    >
      <textarea
        ...
        className="mt-6 h-20 text-[1.2rem] bg-transparent outline-none border-b-2 border-main-light_white block w-full text-main-light_white placeholder:tracking-[2px] placeholder:text-main-light_white"
      />
