...
const Hero = () => {
  return (
    <div className="bg-main-primary pt-28 relative overflow-hidden h-[100vh]">
      ...
      <img src={homeBg} alt="" className="absolute top-0 left-0 w-[30%]" />
      <img
        src={homeBgBottom}
        alt=""
        className="absolute -bottom-10 right-0 w-[28%]"
      />
      ...
      />
      <p className="w-[90%] sm:w-fit mx-auto text-center text-[0.8rem] sm:text-[1.8rem] text-main-light_white pt-10 pb-28 font-miligramLight">
