    ...
    <div className="py-28 w-[95%] sm:w-[90%] mx-auto">
      ...
      <ul className="font-miligramLight text-[1.05rem] text-main-white-700 w-[96%] mx-auto text-justify list-disc pl-10 mt-3">
        ...
        <li>
          ...
          you, Koders does not offer any refunds or money back for services once
          work has commenced and/or has been completed.
        </li>
        <li>
          If you don’t want Koders to start the project at all, you may ask for
          a full refund within 24 hours of making payment. If the project has
          not commenced during this 24 hour period, Koders will deduct any
          expenses, charges, and admin fees incurred and refund you accordingly.
        </li>
        <li>
        ...
        <li>
          ...
          for the services already delivered, or any other miscellaneous charges
          which are non-recoverable for Koders, and refunding them causes any
          loss to Koders.
        </li>
      </ul>
