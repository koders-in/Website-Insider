    ...
    <div className="bg-main-primary overflow-hidden relative">
      ...
      <div className="py-28 w-[95%] sm:w-[90%] mx-auto">
        ...
        <p className="font-miligramLight text-[1.05rem] text-main-white-700 w-[96%] mx-auto text-justify">
          ...
          once assigned to us. A refund is only possible up to a certain extent
          on mutual agreement from both parties when things don't seem to be
          working for valid reasons.
          <br />
          <br />
          ...
          refund if we stop our services and they are no longer operational. If
          a project is cancelled or postponed, Koders holds all charges paid,
          and the client is responsible for all work completed beyond what was
          already paid for.
          <br />
          <br />
          We can’t guarantee a full refund for the cancellation of our services.
          But, if you change your mind after paying us for a certain service,
        ...
        <p className="font-miligramLight text-[1.05rem] text-main-white-700 w-[96%] mx-auto text-justify mt-10">
          ...
          you have already paid is non-refundable. We interact with our clients
          and do our best to answer all of their questions and begin work after
          their approval; Thus, there is no provision for a refund. We
          explicitly stated that the paid amount is non-refundable under any
          circumstances.
          <br />
          <br />
          The services are accessible via purchase. The prices for purchase can
          be found in the individual service descriptions and are subject to
          change. In addition to any services' fee or other charges, you agree
